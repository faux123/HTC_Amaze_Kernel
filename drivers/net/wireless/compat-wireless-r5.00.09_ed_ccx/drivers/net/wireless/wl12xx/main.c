...
static struct conf_drv_settings default_conf = {
	...
	.fwlog = {
		.mode                         = WL12XX_FWLOG_CONTINUOUS,	//WL12XX_FWLOG_ON_DEMAND,
		.mem_blocks                   = 2,
		.severity                     = 0,
		.timestamp                    = WL12XX_FWLOG_TIMESTAMP_ENABLED,	//WL12XX_FWLOG_TIMESTAMP_DISABLED,
		.output                       = WL12XX_FWLOG_OUTPUT_DBG_PINS,	//WL12XX_FWLOG_OUTPUT_HOST,
		.threshold                    = 0,
	},
